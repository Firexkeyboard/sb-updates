...
public class PageBlockRecaptchaV2Invisible : Page
{
    public PageBlockRecaptchaV2Invisible(BlockRecaptchaV2Invisible block)
    {
        DataContext = block;
        ...
        {
            Text              = "reCAPTCHA v2 Invisible Solver",
            FontSize          = 18,
        ...
        AddField(fields, "Output Variable (token)", "OutputVariable", "RC2I_TOKEN");
        ...
        AddField(fields, "Proxy  —  optional (e.g. http://user:pass@host:port)", "Proxy", "");
        AddField(fields, "Server Port  (default: 9513)", "Port", "9513");
        ...
        {
            Text         = "Solves reCAPTCHA v2 Invisible challenges. No site key needed — the solver auto-detects it.",
